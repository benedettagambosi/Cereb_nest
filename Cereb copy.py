...
# Connection weights
conn_weights = {'aa_goc': 1.2, 'aa_pc': 0.7, 'bc_pc': 0.3, 'dcnp_io': 3.0, 'gj_bc': 0.2, 'gj_sc': 0.2, 'glom_dcn': 0.05, 'pf_pc': 0.007*18.667, #0.007
...
# set number of kernels
    ...
    ltp = [0.000001, 0.0001, 0.001]
    ltd = [0.001, 0.1,1.]
    i=0

    for cortex_type in ["EBCC1", "EBCC2"]:
        for LTP in ltp:
            for LTD in ltd:
                i +=1
